 ...
 */
- (void)customCollectionView:(CustomCollectionView *)customCollectionView didSelectCell:(BaseCollectionViewCell *)cell indexPath:(NSIndexPath *)indexPath;
 ...
 */
- (void)customCollectionView:(CustomCollectionView *)customCollectionView cell:(BaseCollectionViewCell *)cell event:(id)event;
